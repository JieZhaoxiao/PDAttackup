...
import attack_context as attack
...
parser.add_argument('--save_dir', default="output/resnet_qwen3_vl_context/15", type=str,
...
def run_diffusion_attack(image, label, diffusion_model, diffusion_steps, guidance=2.5,
    ...
    adv_image, clean_acc, adv_acc = attack.diffattack(diffusion_model, label, controller,
